...
if (biicore.bgMusic) {
  ...
  function playPause() {
    ...
    if (audioPlayer.paused) {
      audioPlayer.play();
      document.getElementById("playerVolumeOff1").style.display = "none";
      document.getElementById("playerVolumeOn1").style.display = "block";
    } else {
      audioPlayer.pause();
      document.getElementById("playerVolumeOff1").style.display = "block";
      document.getElementById("playerVolumeOn1").style.display = "none";
    }
  }
  document.write(`
	<style type="text/css">
